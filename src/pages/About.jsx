                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-4">
                        ...
                        <nav className="hidden md:flex items-center gap-8">
                            ...
                            <Link to="/About" className="text-blue-600 font-medium border-b-2 border-blue-600 pb-1">About</Link>
                        </nav>
                    ...
                    {menuOpen && (
                        <div className="md:hidden bg-white border-t border-gray-200 pt-4 pb-4 space-y-2">
                            ...
                            <Link to="/AIHelp" className="block px-4 text-gray-600 hover:text-blue-600 font-medium">AI Help</Link>
                            <Link to="/About" className="block px-4 text-blue-600 font-medium">About</Link>
                            <Link to="/Favourites">
                                <div className="px-4">
